...
create table if not exists curso(
    ...
    primary key (id),
    constraint pk_cursos_carreras_tecnicas
...
Para realizar una lectura/consulta
sp_entidad_read
...
realizar la insercion de datos en la tabla alumnos.

Parametros con un "_" al inicio
*/
...
CALL sp_alumnos_create("2021048","Jhonatan","Acalon","jacalon-2021048@kinal.edu.gt");

/*
Crear un procedimiento almacenado para consultar 
toda la informacion de la tabla alumnos
*/
DELIMITER $$
DROP PROCEDURE IF EXISTS sp_alumno_read $$
CREATE PROCEDURE sp_alumno_read()
BEGIN
	SELECT 
		a.carne,
		a.nombres,
...
/*
Crear un procedimiento almacenado para 
actualizar la informacion de la tabla alumnos
*/
DELIMITER $$
DROP PROCEDURE IF EXISTS sp_alumno_update $$
...
CALL sp_alumno_update("2021048","Jose","Andrade","jandrade-2021048@kinal.edu.gt");

/*
Crear un procedimiento almacenado para eliminar
un registro en la tabla de alumnos.
*/
DELIMITER $$
DROP PROCEDURE IF EXISTS sp_alumno_delete $$
